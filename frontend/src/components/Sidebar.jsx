...
export default function Sidebar({ onFilterByTag, onActivityClick, onOpenItem, width = 320 }) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="h-20 flex items-center justify-center px-1 border-b border-white/10 flex-shrink-0">
        <img
          src={logo}
          alt="DocMatrix"
          className="h-16 w-auto max-w-[96%] object-contain scale-110 drop-shadow-xl transition-transform duration-200"
        />
      </div>
